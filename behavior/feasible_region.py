...
class FeasibleRegion:
    ...
    def __init__(self, init_s: List[float]) -> None:
        ...
        max_deceleration = -config_module.FLAGS_longitudinal_acceleration_lower_bound
    ...
    def SUpper(self, t: float) -> float:
        ...
        return (self._init_s[0] + self._init_s[1] * t +
                0.5 * config_module.FLAGS_longitudinal_acceleration_upper_bound * t * t)
    ...
    def SLower(self, t: float) -> float:
        ...
        if t < self.t_at_zero_speed_:
            return (self._init_s[0] + self._init_s[1] * t +
                    0.5 * config_module.FLAGS_longitudinal_acceleration_lower_bound * t * t)
    ...
    def VUpper(self, t: float) -> float:
        ...
        :rtype: float
        """
        return self._init_s[1] + config_module.FLAGS_longitudinal_acceleration_upper_bound * t
    ...
    def VLower(self, t: float) -> float:
        ...
        """
        if t < self.t_at_zero_speed_:
            return self._init_s[1] + config_module.FLAGS_longitudinal_acceleration_lower_bound * t
        return 0.0
    ...
    def TLower(self, s: float) -> float:
        ...
        a = config_module.FLAGS_longitudinal_acceleration_upper_bound
