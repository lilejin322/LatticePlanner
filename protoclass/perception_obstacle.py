...
class PerceptionObstacleType(Enum):
    UNKNOWN = 0
    UNKNOWN_MOVABLE = 1
    UNKNOWN_UNMOVABLE = 2
    PEDESTRIAN = 3
...
class PerceptionObstacleSubType(Enum):
    ST_UNKNOWN = 0
...
class SensorMeasurement:
    ...
    type: Optional[PerceptionObstacleType] = None
    sub_type: Optional[PerceptionObstacleSubType] = None
...
class PerceptionObstacle:
    ...
    Type = PerceptionObstacleType

    type: Optional[PerceptionObstacleType] = None  # obstacle type
    ...
    SubType = PerceptionObstacleSubType

    sub_type: Optional[PerceptionObstacleSubType] = None  # obstacle sub_type
...
class LaneMarker:
    ...
    lane_type: Optional[LaneBoundaryType] = None
