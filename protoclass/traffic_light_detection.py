"""
Traffic Light Detection submodule
"""
...
class TrafficLightDebug:
    ...
    box: List[TrafficLightBox] = field(default_factory=list)
    ...
    crop_roi: List[TrafficLightBox] = field(default_factory=list)
    projected_roi: List[TrafficLightBox] = field(default_factory=list)
    rectified_roi: List[TrafficLightBox] = field(default_factory=list)
    debug_roi: List[TrafficLightBox] = field(default_factory=list)
...
class TrafficLightDetection:
    ...
    traffic_light: List[TrafficLight] = field(default_factory=list)
