...
class ReferenceLineInfo:
    ...
    def __init__(self, vehicle_state: VehicleState=None, adc_planning_point: TrajectoryPoint=None, reference_line: ReferenceLine=None, segments: RouteSegments=None):
        ...
        self._lanes = segments
        self._cost = 0.0
        self._is_drivable = True
        self._path_decision = None
        self._blocking_obstacle = None
        self._candidate_path_boundaries = []
        self._candidate_path_data = []
        self._path_data = None
        self._fallback_path_data = None
        self._speed_data = None
        self._discretized_trajectory = None
        self._rss_info = None
        self._adc_sl_boundary = None
        self._debug = None
        self._latency_stats = None
        self._is_on_reference_line = False
        self._is_path_lane_borrow = False
        self.status_ = None
        self._offset_to_other_reference_line = 0.0
        self._priority_cost = 0.0
        self._planning_target = None
        self._trajectory_type = None
        self._first_encounter_overlaps = []
        self._st_graph_data = None
        self._vehicle_signal = None
        self._cruise_speed = 0.0
        self._base_cruise_speed = 0.0
        self._path_reusable = False
        self._junction_right_of_way_map = {}
