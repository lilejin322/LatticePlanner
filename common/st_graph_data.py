...
from common.speed_limit import SpeedLimit
from common.st_boundary import STBoundary
from typing import List,Tuple
from protoclass.st_drivable_boundary import STDrivableBoundary, STDrivableBoundaryInstance
...
class StGraphData:
    ...
    def cruise_speed(self) -> float:
        ...
        return self._cruise_speed if self._cruise_speed > 0.0 else config_module.FLAGS_default_cruise_speed
