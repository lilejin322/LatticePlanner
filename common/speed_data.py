...
class SpeedData(UserList):
    """
    SpeedData class, iherited from list to store List[SpeedPoint]
    """

    def __init__(self, speed_points: Optional[List[SpeedPoint]] = None):
        """
        Constructor
        """

        super().__init__(sorted(speed_points or [], key=lambda p: p.t))
    ...
    def __str__(self) -> str:
        ...
        limit = min(len(self), config_module.FLAGS_trajectory_point_num_for_debug)
