...
class PathData:
    ...
    def __init__(self):
        ...
        self._lattice_candidate_id: int = -1
    ...
    def __str__(self) -> str:
        ...
        limit: int = min(len(self._discretized_path), config_module.FLAGS_trajectory_point_num_for_debug)
    ...
    def set_lattice_candidate_id(self, candidate_id: int) -> None:
        self._lattice_candidate_id = candidate_id

    def lattice_candidate_id(self) -> int:
        return self._lattice_candidate_id
